...
do
    ...
    Utility.SaveConfig = function(Config)
        ...
        writefile(
            "apollo/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json", 
    ...
    Utility.LoadConfig = function(Config)
        local CFG = HttpService:JSONDecode(readfile("apollo/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json"))
        --
...
do
    function Library.CreateLoader(Title, WindowSize)
        ...
        --
        Library.Theme.Logo = Utility.AddImage("apollo/Assets/UI/Logo2.png", "https://i.imgur.com/JyVUTVM.png")
        --
        ...
        --
        Utility.AddFolder("apollo")
        Utility.AddFolder("apollo/Caches")
        Utility.AddFolder("apollo/Assets")
        Utility.AddFolder("apollo/Assets/UI")
        Utility.AddFolder("apollo/Configs")
        Utility.AddFolder("apollo/Scripts")
        --
        Library.Theme.Gradient = Utility.AddImage("apollo/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        -- Library.Theme.SecondIcon = Utility.AddImage("apollo/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        Library.Theme.Hue = Utility.AddImage("apollo/Assets/UI/Hue.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/HuePicker.png")
        Library.Theme.Saturation = Utility.AddImage("apollo/Assets/UI/Saturation.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/SaturationPicker.png")
        Library.Theme.SaturationCursor = Utility.AddImage("apollo/Assets/UI/HueCursor.png", "https://raw.githubusercontent.com/mvonwalk/splix-assets/main/Images-cursor.png")
        --
        Library.Theme.Dummy = Utility.AddImage("apollo/Assets/UI/Dummy.png", "https://i.imgur.com/6M6buVv.png")
        Library.Theme.Astolfo = Utility.AddImage("apollo/Assets/UI/Astolfo.png", "https://i.imgur.com/T20cWY9.png")
        Library.Theme.Aiko = Utility.AddImage("apollo/Assets/UI/Aiko.png", "https://i.imgur.com/1gRIdko.png")
        Library.Theme.Rem = Utility.AddImage("apollo/Assets/UI/Rem.png", "https://i.imgur.com/ykbRkhJ.png")
        Library.Theme.Violet = Utility.AddImage("apollo/Assets/UI/Violet.png", "https://i.imgur.com/7B56w4a.png")
        Library.Theme.Asuka = Utility.AddImage("apollo/Assets/UI/Asuka.png", "https://i.imgur.com/3hwztNM.png")
        --
        if not isfolder("apollo/Configs/" .. game.PlaceId) then
            makefolder("apollo/Configs/" .. game.PlaceId)
        end
        --
        ...
        function Window:Tab(Title)
            ...
            function Tab:Section(Title, Side)
                ...
                function Section:TextBox(Options)
                    ...
                    InputHandler.Name = ("apollo-INPUT-%s"):format(HttpService:GenerateGUID(false))
                    --
